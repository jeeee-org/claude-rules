...
## 完了
- [x] 2026-09-19 英数字と日本語の間の半角スペース（§9違反）を、PJの`CLAUDE.md`・雛形とスキル3本・`README.md`・正本1か所から落とした（3コミット）。機械置換の壊し方と網の粗さは記録にある → [checkpoint](checkpoints/2026-09-19-体裁の統一-境目の半角スペース.md)
